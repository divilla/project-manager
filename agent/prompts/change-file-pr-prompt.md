...
Use Change spec `specs/<change-name>.md` as the PR contract. Before writing, inspect the full current branch diff, including untracked files. The PR draft must accurately reflect both the Change spec and every
...
- Include a References section listing the Change spec as mandatory, plus all relevant docs files used by the branch.
...
- If the Change spec and branch diff conflict, stop and report the exact conflict instead of drafting the PR.
