...
1. Change is created without a ref/run configuration.
2. Ref is assigned.
3. Current global Flow stages and default stage modes are copied onto the Change.
4. User can adjust flow_stage_modes for that Change.
5. Later global Flow config changes do not affect this Change.
6. Runner uses the Change’s copied flow_stages and flow_stage_modes.
