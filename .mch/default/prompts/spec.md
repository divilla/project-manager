...
- Use `specs/<change-slug>.md` as the generated Change spec path when the template needs that path.
...
- `Relevant Specs`: `specs/<change-slug>.md` and materially relevant docs.
