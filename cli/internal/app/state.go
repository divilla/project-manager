...
const (
	...
	CreateDefState             = navigation.CreateDefState
	UpdateDefState             = navigation.UpdateDefState
	RewriteDefState            = navigation.RewriteDefState
	...
	TestCaseDeleteConfirmation = navigation.TestCaseDeleteConfirmation
