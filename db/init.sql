...
begin
    insert into public.change_history (
        id, version, project_id, change_types, epic_id, title, idea, spec, agent_edit, modified, deleted
    )
    select
        id, version, project_id, change_types, epic_id, title, idea, spec, agent_edit, modified, _deleted
    from public.change
    where id = _id;
end;
$$;
