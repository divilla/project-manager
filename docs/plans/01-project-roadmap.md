...
- Local application shell with Vue, Quasar, Go, Echo, and PostgreSQL.
- Health diagnostics and local CORS.
- Project creation and selection.
- Baseline docs and verification commands.
...
- Data model review before any production hardening.
- Decision on authentication, hosted deployment, and multi-user features.
