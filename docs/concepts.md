...
- `body`: markdown-capable description.
...
## Requirement
A requirement is a binary Definition of Done item for a change. It must be concrete, verifiable, and small enough to evaluate independently.
...
## Completeness
Completeness is calculated from requirements:

```text
completeness = completed requirements / total requirements * 100
```
